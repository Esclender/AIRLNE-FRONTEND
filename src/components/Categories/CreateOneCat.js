...
import { Button as Btn, Alert, Textarea } from '@material-tailwind/react'
import { Error } from '@mui/icons-material'

import { useState } from 'react'

export function CreateOneCat ({ headers, instance, setRows, labels, setModalPretext, setModalPre, modalNew, setModalNew }) {
            ...
            <div>
              {
                  headers.map((head, i) => {
                    if (head != 'beneficies') {
                      ...
                      return <Textarea onChange={(e) => getTextArea(e)} label="Beneficios (Separa cada uno de los beneficios con comas)" />
                    }
                  })
              }
